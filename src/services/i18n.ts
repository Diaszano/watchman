...
const en: Dict = {
  ...
  'settings.playlistMode.sequential': 'Sequential',
  'settings.playlistMode.random': 'Random',
  'settings.clear': 'Clear',
  'logo.uploadPrompt': 'Upload a logo in Settings',
...
const pt: Dict = {
  ...
  'settings.playlistMode.sequential': 'Sequencial',
  'settings.playlistMode.random': 'Aleatório',
  'settings.clear': 'Limpar',
  'logo.uploadPrompt': 'Envie um logo nas Configurações',
